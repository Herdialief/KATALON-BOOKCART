...
WebUI.verifyElementPresent(findTestObject('Wishlist/th_Image'), 0)

WebUI.verifyElementPresent(findTestObject('Wishlist/th_Price'), 0)

WebUI.verifyElementPresent(findTestObject('Wishlist/th_Cart'), 0)

WebUI.verifyElementPresent(findTestObject('Wishlist/th_Wishlist'), 0)

WebUI.verifyElementPresent(findTestObject('Wishlist/span_Clear Wishlist'), 0)

WebUI.verifyElementPresent(findTestObject('Wishlist/span_Add to Cart'), 0)
