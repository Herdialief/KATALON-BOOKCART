...
WebUI.click(findTestObject('Wishlist/span_Clear Wishlist'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Wishlist/mat-card-title_Your wishlist is empty'), 0)

WebUI.verifyElementPresent(findTestObject('Wishlist/span_Continue shopping'), 0)
