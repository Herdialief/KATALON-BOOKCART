...
WebUI.click(findTestObject('Header/span_shopping_cart'))

WebUI.verifyElementPresent(findTestObject('Cart/mat-card-title_Shopping cart'), 0)

WebUI.verifyElementPresent(findTestObject('Cart/mat-card-title_Your shopping cart is empty'), 0)

WebUI.verifyElementPresent(findTestObject('Cart/span_Continue shopping'), 0)
