...
WebUI.setText(findTestObject('Register Page/input_User name'), '')
...
WebUI.verifyElementPresent(findTestObject('Register Page/mat-error_User Name is required'), 0)

WebUI.verifyElementText(findTestObject('Register Page/mat-error_User Name is required'), 'User Name is required')
