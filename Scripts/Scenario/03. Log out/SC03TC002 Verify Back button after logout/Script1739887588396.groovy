...
WebUI.callTestCase(findTestCase('Blocks/Account/Logout'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Blocks/Browser/Back Button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Category/span_All Categories'), 0)
